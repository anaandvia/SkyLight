...
<div class="col-md-10 p-5 pt-2">
    <h3><i class="fas fa-tv mr-2"></i>SlideShow</h3><hr>
        <form class="form-inline my-2 my-lg-0 ml-auto">
            <a href="#" id="tambahss" class="btn btn-light mb-2 btndata"><i class="fas fa-plus-circle mr-2"></i>TAMBAH SLIDESHOW</a>
        ...
        <?php 
            include 'koneksi.php';
            $no = 1;
            $sql = mysqli_query($koneksi, "select*from slideshow");
            while($data = mysqli_fetch_array($sql)){
            ?>
            <tr>
                <td><?php echo $no++; ?></td>
                <td><?php echo $data['Id']; ?></td>
                <td><?php echo "<img src ='img/slider/".$data['Foto']."' width = '100' height = '100'>" ;?></td>
                <td>
                <a href="#" data-role="pop" data-id="<?php echo $data['Id'];?>"><i class="fas fa-edit bg-success p-2 text-white rounded"></i></a>
                <a href="#" data-role="pop2" data-id ="<?php echo $data['Id']?>"><i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i></a>
                <!-- Modal Edit -->
                <div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Ubah Data Slideshow</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                        <form action="update_slideshow.php" enctype="multipart/form-data" method="post">
                            <div class="form-row">
            ...
            ?>
                ...
                <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Hapus Slideshow</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                        <form action="delete_slideshow.php" method="post">
...
<div class="modal fade" id="ModalTambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-body">
        <form action="simpan_slideshow.php" enctype="multipart/form-data" method="post">
        <div class="form-row">
            <div class="form-group col-md-6">
                <label >id</label>
