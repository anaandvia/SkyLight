...
<div class="col-md-10 p-5 pt-2">
    <h3><i class="fas fa-hotel mr-2"></i>Data Hotel</h3><hr>
        <form class="form-inline my-2 my-lg-0 ml-auto">
            <a href="#" id="tambahdh" class="btn mb-2 mr-2 btndata"><i class="fas fa-plus-circle mr-2"></i>TAMBAH DATA HOTEL</a>
            <a href="laporan_datahotel.php" class="btn mb-2 mr-2 btndata"><i class="fas fa-print mr-2"></i>CETAK DATA HOTEL</a>
        ...
        <tbody>
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $sql = mysqli_query($koneksi, "select * from datahotel where Nama like '%".$cari."%' or Alamat like '%".$cari."%' or idhotel like '%".$cari."%'");
                echo "<b>Hasil pencarian : ".$cari."</b>";
            }else{
            $sql = mysqli_query($koneksi, "select*from datahotel");
            }
            $no = 1;
            ...
            <tr>
                ...
                <td>
                <a href="#" data-role="pop" data-id="<?php echo $data['idhotel'];?>"><i class="fas fa-edit bg-success p-2 text-white rounded"></i></a>
                <a href="#" data-role="pop2" data-id="<?php echo $data['idhotel'];?>"><i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i></a>
                <!-- Modal Edit -->
                <div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <form action="update_datahotel.php" method="post">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label >ID Hotel</label>
                                    <input type="text" name="idhotel" class="form-control" id="idhotel" readonly>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label >ALAMAT</label>
                                    <textarea class="form-control rounded-0" name="Alamat" id="Alamat" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
            ...
            ?>
                ...
                <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Hapus Data Hotel</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                        <form action="delete_datahotel.php" method="post">
...
<div class="modal fade" id="ModalTambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-body">
        <form action="simpan_datahotel.php" method="post">
        <div class="form-row">
            <div class="form-group col-md-6">
                <label >ID Hotel</label>
...
<!-- /Modah Tambah -->
    ...
    <script>
        ...
        $("a[data-role=pop]").click(function(){
            ...
            $.ajax({
                type:'POST',
                url: 'getdatahotel.php',
                data:{id:id},
                success:function(data){
                    console.log(data);
                    $('#ModalEdit').modal();
                    var row = JSON.parse(data);
                    console.log(row['idhotel']);
